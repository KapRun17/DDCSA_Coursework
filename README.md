...
Набор включает smoke-проверки API и интеграционные сценарии для RBAC, владения профилями, шаблонами и заявками, модерации, откликов и доступа к диалогам. Для интеграционных тестов требуется доступная PostgreSQL, указанная в `DATABASE_URL`.
